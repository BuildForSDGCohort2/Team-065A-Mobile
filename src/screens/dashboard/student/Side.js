      ...
      <Content style={{ backgroundColor: "#FFFFFF" }}>
        ...
        <View style={{ marginLeft: 15, marginTop: 40, marginRight: 15 }}>
          ...
          >
            ...
            <Text style={styles.txtOption}>Available Teachers</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.txtOption}>Book a Teacher</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.txtOption}>Available subjects</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.txtOption}>Opportunities</Text>
          </TouchableOpacity>
          {/* 6 */}
          <View style={styles.lineA}></View>
          ...
          >
            ...
            <Text style={styles.txtOption}>Scholarships/Funding</Text>
          </TouchableOpacity>
          {/* 7 */}
          <View style={styles.lineA}></View>
